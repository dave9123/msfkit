...
banner
sleep 0.01
echo -n $hi"    [1]$ku Install Bahan     "   $hi"[2]$ku Sudah Install   ";
sleep 0.01
echo -n $hi"          [3]$ku Updates Script    " $hi"[4]$ku Contact Person  ";
sleep 0.01
echo -n $hi"          [0]$ku exit";
sleep 0.01
echo $hi
...
clear
banner
echo -n $hi"[1]$cy install metasploit" $hi"[2]$cy buat backdoor otomatis    "
sleep 0.01
echo -n $hi"[3]$cy exploit metasploit" $hi"[4]$cy update scripts"
sleep 0.01
echo
echo $hi"[5]$cy exit"
sleep 0.01
...
echo
sleep 0.01
echo "  gunakan port dari portmap 5 digit beda jaringan  "
sleep 0.01
echo $me
echo "----------------------------------------------------"
echo $cy"   sesuaikan port backdoor satu jaringan =>$me 4444"
echo
...
echo
echo
echo $ku"           backdoor script python php               "
sleep 0.01
...
clear
banner
echo $ku"[+] gunakan ip tune0 untuk jarak jauh atau beda jaringan"
sleep 3
echo
...
echo $ku"----------------------------------------------------"
echo $hi
read -p "masukan ip tun0 atau ip lokal : " l
echo
sleep 0.01
echo $ku
clear
...
echo $me
echo "----------------------------------------------------"
echo $hi"  sesuaikan port backdoor satu jaringan =>$me 4444"
echo
...
clear
banner
echo -n $un"[1]$cy Backdoor Deffault"  $un"[2]$cy Backdoor Python            "
sleep 0.01
echo -n $un"[3]$cy Backdoor PHP     "   $un"[4]$cy Backdoor Original"
sleep 0.01
echo
echo $un"[0]$cy Kembali  ";
echo $bi
read -p "masukan pilihan : " pi
}
...
clear
banner
echo $cy"[1]$bi android versi 5-6"
echo $cy"[2]$bi android versi 7-10"
echo $cy"[0]$bi kembali"
echo $cy
read -p "masukan pilihan : " pi
sleep 2
clear
...
clear
banner
echo -n $bi"[1]$me Exploit Aplikasi"   $bi"[2]$me Exploit Python              "
echo -n $bi"[3]$me Exploit PHP     "   $bi"[0]$me Kembali"
echo
echo $bi
read -p "masukan pilihan : " pi
}
